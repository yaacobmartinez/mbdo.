        ...
        <div>
            ...
            <div className={classes.root}>
                <div className={classes.titleHolder}>
                    <Typography className={classes.titleName} >Transactions</Typography>
                    <Typography className={classes.titleCaption} gutterBottom>All of your transactions live here.</Typography>
                </div>
